...
//        }).disposed(by: rx.disposeBag)
        ...
        RxEpubReader.shared.config.backgroundColor.accept("#C7EDCC")
        RxEpubReader.shared.config.textColor.accept("#888888")
        RxEpubReader.shared.config.fontSize.accept(14)
